...
import com.perry.audiorecorder.util.OnCopyListener
import com.perry.audiorecorder.util.copyFileToDir
...
class MoveRecordsService : Service() {
	...
	companion object {
		...
		private const val CHANNEL_ID = "com.perry.audiorecorder.MoveRecords.Notification"
