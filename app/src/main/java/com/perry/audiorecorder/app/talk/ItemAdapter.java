...
import com.perry.audiorecorder.app.widget.VoiceImageView;
 ...
 * 适配器
 */
public class ItemAdapter extends BaseQuickAdapter<File, BaseViewHolder> {

    private int mCurrentPlayAnimPosition = -1;//当前播放动画的位置

    public ItemAdapter() {
        super(R.layout.adapter_chat_list_right_voice);
    }
