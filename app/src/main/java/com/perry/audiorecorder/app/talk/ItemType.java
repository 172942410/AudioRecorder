...
public class ItemType implements Parcelable {
	...
	public ItemType(long id, int type, String name, String format, String description, long duration,
	...
	public static ItemType createHeaderItem() {
		return new ItemType(-1, ItemType.ITEM_TYPE_HEADER, "HEADER", "", "", 0, 0, 0, 0, "", 0, 0, 0, false, null);
	}

	public static ItemType createFooterItem() {
		return new ItemType(-1, ItemType.ITEM_TYPE_FOOTER, "FOOTER", "", "", 0, 0, 0, 0, "", 0, 0, 0, false, null);
	}

	public static ItemType createDateItem(long date) {
		return new ItemType(-1, ItemType.ITEM_TYPE_DATE, "DATE", "", "", 0, 0, 0, date, "", 0, 0, 0, false, null);
	}
...
//		return TimeUtils.formatTime(time);
	...
	public static final Creator<ItemType> CREATOR
			= new Creator<ItemType>() {
