...
import com.perry.audiorecorder.*
...
class DecodeService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "com.perry.audiorecorder.Decode.Notification"
    ...
    private fun startDecode(id: Int) {
        ...
        processingTasks.postRunnable {
            ...
            if (rec != null && rec.duration / 1000 < AppConstants.DECODE_DURATION) {
                waveformVisualization.decodeRecordWaveform(
                    rec.path,
                    object : AudioDecodingListener {
